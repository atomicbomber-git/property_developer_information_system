...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_vue_multiselect__ = __webpack_require__(63);
  ...
  return _c(
    ...
    [
      ...
      _c("div", { staticClass: "form-group" }, [
        _c("label", { attrs: { for: "receivement_date" } }, [
        ...
        _c("input", {
          directives: [
            {
              name: "model",
              rawName: "v-model",
              value: _vm.receivement_date,
              expression: "receivement_date"
            }
          ],
          ...
          domProps: { value: _vm.receivement_date },
          on: {
            input: function($event) {
              if ($event.target.composing) {
                return
              }
              _vm.receivement_date = $event.target.value
            }
          }
        }),
        _vm._v(" "),
        _c("div", { staticClass: "invalid-feedback" }, [
          _vm._v(
            _vm._s(
              _vm.get(this.error_data, "errors.receivement_date[0]", false)
            )
          )
        ])
      ]),
