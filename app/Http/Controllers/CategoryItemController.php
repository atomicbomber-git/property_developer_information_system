...
class CategoryItemController extends Controller
{
    public function index(Category $category)
    {
        ...
        return view('category_item.index', compact('items', 'category', 'latest_prices'));
    }
    ...
    public function create(Category $category)
    {
        ...
        return view('category_item.create', compact('vendors', 'categories', 'category'));
    }
    ...
    public function processCreate(Category $category)
    {
        ...
        return redirect()
            ->route('category-item.index', $category)
    ...
    public function update(Category $category, Item $item) {
        ...
        return view('category_item.update', compact('vendors', 'item', 'category'));
    }
    ...
    public function priceHistory(Category $category, Item $item)
    {
        ...
        return view('category_item.price_history', compact('category', 'item', 'item_prices'));
    }
}
